...
function ageInDays() {
  ...
  var textAnswer = document.createTextNode(
    "You are " + ageInDays.toString() + " days old."
  );
...
function generateCat() {
  ...
  catDiv.innerHTML =
    "<img class='cat-image' src='http://thecatapi.com/api/images/get?format=src&type=gif&size=small'>";
...
function rpsFrontEnd(humanImageChoice, DEALERImageChoice, finalMessage) {
  ...
  DEALERDiv.innerHTML =
    "<img src='" +
    imagesDatabase[DEALERImageChoice] +
